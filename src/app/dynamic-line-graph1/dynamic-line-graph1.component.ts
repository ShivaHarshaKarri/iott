...
@Component({
  selector: 'app-dynamic-line-graph1',
  templateUrl: './dynamic-line-graph1.component.html',
  styleUrls: ['./dynamic-line-graph1.component.css']
})
export class DynamicLineGraph1Component implements OnInit,OnDestroy {
