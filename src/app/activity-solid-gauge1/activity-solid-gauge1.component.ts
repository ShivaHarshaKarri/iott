...
@Component({
  selector: 'app-activity-solid-gauge1',
  templateUrl: './activity-solid-gauge1.component.html',
  styleUrls: ['./activity-solid-gauge1.component.css']
})
export class ActivitySolidGauge1Component implements OnInit {
...
constructor(iconRegistry: MatIconRegistry, sanitizer: DomSanitizer) {
  ...
  ngOnInit() {
    ...
    setInterval(()=>{
      this.gauge.series[0].data[0].y = Math.round((Math.random()) * 50)
      this.gauge.series[1].data[0].y = Math.round((Math.random()) * 70)
      this.gauge.series[2].data[0].y = Math.round((Math.random()) * 100)
      this.chartInst.series[0].points[0].update(this.gauge.series[0].data[0].y);
      this.chartInst.series[1].points[0].update(this.gauge.series[1].data[0].y);
      this.chartInst.series[2].points[0].update(this.gauge.series[2].data[0].y);
    },2000)
