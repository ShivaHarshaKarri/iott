...
@Component({
  selector: 'app-chart2',
  templateUrl: './solidGauge1.component.html',
  styleUrls: ['./solidGauge1.component.css']
})
export class SolidGauge1Component implements OnInit {
...
constructor(iconRegistry: MatIconRegistry, sanitizer: DomSanitizer) {
  ...
  ngOnInit() {
    ...
    setInterval(()=>{
      this.gauge.series[0].data = [Math.round((Math.random()) * 100)]
      this.updateSeriesData(this.gauge.series[0].data);
    },2000)
  }
